...
"""
========================================================
  KHNK X TERMINAL EXPERIENCE — "Risk It All"
  Dibuat oleh: Khnk X
========================================================
...
SONG_TITLE = "RISK IT ALL - BRUNO MARS"
...
LYRICS = [
    {
        "text": "I would run through a fire",
        "typing_speed": 0.06,
        "line_pause": 0.50,
    },
    {
        "text": "Just to be by your side",
        "typing_speed": 0.07,
        "line_pause": 0.80,
    },
    {
        "text": "If your heart's on the line",
        "typing_speed": 0.05,
        "line_pause": 0.40,
    },
    {
        "text": "You could take mine",
        "typing_speed": 0.12,
        "line_pause": 1.80,
    },
    # Silakan tambahkan sisa lirik yang kamu temukan di Google Search di bawah ini.
    # Formatnya:
    # {
    #     "text": "Teks lirik baris selanjutnya",
    #     "typing_speed": 0.06,
    #     "line_pause": 0.50,
    # },
]
